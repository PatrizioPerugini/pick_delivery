...
if("TRUE" STREQUAL "TRUE")
  set(robot_navigation_SOURCE_PREFIX /home/patrizio/Desktop/pick_delivery/pick_delivery/prog_ws/src/robot_navigation)
  set(robot_navigation_DEVEL_PREFIX /home/patrizio/Desktop/pick_delivery/pick_delivery/prog_ws/devel/.private/robot_navigation)
  ...
  set(robot_navigation_INSTALL_PREFIX /home/patrizio/Desktop/pick_delivery/pick_delivery/prog_ws/install)
...
if(NOT "/home/patrizio/Desktop/pick_delivery/pick_delivery/prog_ws/devel/.private/robot_navigation/include " STREQUAL " ")
  set(robot_navigation_INCLUDE_DIRS "")
  set(_include_dirs "/home/patrizio/Desktop/pick_delivery/pick_delivery/prog_ws/devel/.private/robot_navigation/include")
  if(NOT " " STREQUAL " ")
    set(_report "Check the issue tracker '' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT " " STREQUAL " ")
    set(_report "Check the website '' for information and consider reporting the problem.")
  else()
    set(_report "Report the problem to the maintainer 'patrizio <patrizio@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'robot_navigation' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/patrizio/Desktop/pick_delivery/pick_delivery/prog_ws/src/robot_navigation/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/patrizio/Desktop/pick_delivery/pick_delivery/prog_ws/devel/.private/robot_navigation/lib;/home/patrizio/Desktop/pick_delivery/pick_delivery/prog_ws/devel/lib;/opt/ros/melodic/lib)
